...
function ChromeTab({ title = 'New Tab', active = false }: ChromeTabProps) {
...
function ChromeTabBar({ tabs = [{ title: 'New Tab' }], activeIndex = 0 }: ChromeTabBarProps) {
  return (
    <div style={{
...
function ChromeToolbar({ url = 'example.com' }: ChromeToolbarProps) {
  const iconDot = (
    <div style={{
